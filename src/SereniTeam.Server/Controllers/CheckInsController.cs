...
public class CheckInsController : ControllerBase
{
	...
	/// </summary>
	[HttpGet("team/{teamId}")]
	public async Task<ActionResult> GetTeamCheckIns(int teamId, [FromQuery] DateTime? fromDate = null)
	{
		try
		{
			var checkIns = await _checkInService.GetTeamCheckInsAsync(teamId, fromDate);
